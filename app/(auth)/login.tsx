...
export default function LoginPage() {
    ...
    const { control, handleSubmit, reset, watch, setValue, formState: { errors, isDirty, isValid } } = useForm({
            ...
            <WithKeyboard>
                <Wrapper style={{ backgroundColor: 'white', height: height }}>
                    ...
                    <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
                        ...
                        <View>
                            <CustomButton title='Masuk' onPress={handleSubmit(data => handleLogin(data))} size='md' loading={loginLoading} />
